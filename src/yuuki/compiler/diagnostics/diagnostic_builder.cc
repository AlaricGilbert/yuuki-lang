...
namespace yuuki::compiler::diagnostics{
    ...
    DiagnosticBuilder::ErrorAtBuildContext::ErrorAtBuildContext(CompileError error, std::size_t contextID, std::size_t tokenID) {
        _errorCode = error;
        _contextID = contextID;
        _tokenID = tokenID;
    }

    DiagnosticBuilder::ErrorAfterBuildContext::ErrorAfterBuildContext(CompileError error, std::size_t contextID, std::size_t tokenID) {
        _errorCode = error;
        _contextID = contextID;
        _tokenID = tokenID;
    }
